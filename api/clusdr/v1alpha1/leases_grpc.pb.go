...
type LeaseServiceClient interface {
	...
	Renew(ctx context.Context, in *LeaseServiceRenewRequest, opts ...grpc.CallOption) (*LeaseServiceRenewResponse, error)
...
func (c *leaseServiceClient) Grant(ctx context.Context, in *GrantRequest, opts ...grpc.CallOption) (*GrantResponse, error) {
...
func (c *leaseServiceClient) Renew(ctx context.Context, in *LeaseServiceRenewRequest, opts ...grpc.CallOption) (*LeaseServiceRenewResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LeaseServiceRenewResponse)
...
type LeaseServiceServer interface {
	...
	Renew(context.Context, *LeaseServiceRenewRequest) (*LeaseServiceRenewResponse, error)
...
func (UnimplementedLeaseServiceServer) Grant(context.Context, *GrantRequest) (*GrantResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Grant not implemented")
}
func (UnimplementedLeaseServiceServer) Renew(context.Context, *LeaseServiceRenewRequest) (*LeaseServiceRenewResponse, error) {
...
func _LeaseService_Renew_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LeaseServiceRenewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LeaseServiceServer).Renew(ctx, req.(*LeaseServiceRenewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
