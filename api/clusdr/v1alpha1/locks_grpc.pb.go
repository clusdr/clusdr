...
type LockServiceClient interface {
	...
	Renew(ctx context.Context, in *RenewLockRequest, opts ...grpc.CallOption) (*RenewLockResponse, error)
...
func (c *lockServiceClient) TryLock(ctx context.Context, in *LockRequest, opts ...grpc.CallOption) (*LockResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LockResponse)
...
func (c *lockServiceClient) Renew(ctx context.Context, in *RenewLockRequest, opts ...grpc.CallOption) (*RenewLockResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type LockServiceServer interface {
	...
	// Renew extends the deadline. holder + fencing_token must match.
	Renew(context.Context, *RenewLockRequest) (*RenewLockResponse, error)
	// ListLocks returns every currently held lock.
...
func (UnimplementedLockServiceServer) TryLock(context.Context, *LockRequest) (*LockResponse, error) {
...
func (UnimplementedLockServiceServer) Renew(context.Context, *RenewLockRequest) (*RenewLockResponse, error) {
...
func _LockService_TryLock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LockServiceServer).TryLock(ctx, req.(*LockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LockService_Renew_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LockServiceServer).Renew(ctx, req.(*RenewLockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
