...
<p align="center">
  ...
  <a href="https://scorecard.dev/viewer/?uri=github.com/clusdr/clusdr"><img src="https://api.scorecard.dev/projects/github.com/clusdr/clusdr/badge" alt="OpenSSF Scorecard"></a>
...
Go: `go get github.com/clusdr/clusdr/sdk`. Python: `pip install clusdr`. Rust: `clusdr = "0.2.1"`. TypeScript: `npm install clusdr`. Java: `io.clusdr:clusdr`. Runnable copies: [examples/](examples/).
